...
def main():
    ...
    print('====================================================================', flush=True)
    print(' SECURITY NOTICE: ClearLedger is bound to 127.0.0.1 for local use.', flush=True)
    print(' Do NOT expose this server to untrusted or external networks.', flush=True)
    print('====================================================================', flush=True)
    print(f'ClearLedger running at: http://127.0.0.1:{server.server_port}  (Ctrl+C to stop)', flush=True)
    try:
